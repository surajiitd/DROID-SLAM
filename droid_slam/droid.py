...
class Droid:
    def __init__(self, args):
        ...
        self.video = DepthVideo(
            args.image_size, args.buffer, stereo=args.stereo)

        # filter incoming frames so that there is enough motion
        self.filterx = MotionFilter(
            self.net, self.video, thresh=args.filter_thresh)
    ...
    def track(self, tstamp, image, depth=None, intrinsics=None, gt_pose = None, gt_depth = None):
        ...
        with torch.no_grad():
            ...
            self.filterx.track(tstamp, image, depth, intrinsics, gt_pose, gt_depth)
