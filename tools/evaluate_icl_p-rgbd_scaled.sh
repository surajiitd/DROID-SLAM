...
for seq in ${evalset[@]}; do
    CUDA_VISIBLE_DEVICES=7 python evaluation_scripts/test_icl.py --stride=1 --scaled_prgbd --modality=p-rgbd --dataset_name=icl --datapath=$ICL_PATH/$seq --weights=droid.pth --disable_vis $@
done
