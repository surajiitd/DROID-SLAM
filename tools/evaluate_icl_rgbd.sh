...
for seq in ${evalset[@]}; do
    CUDA_VISIBLE_DEVICES=2 python evaluation_scripts/test_icl.py --stride=1 --modality=rgbd --dataset_name=icl --datapath=$ICL_PATH/$seq --weights=droid.pth --disable_vis $@
done
