...
for seq in ${evalset[@]}; do
    CUDA_VISIBLE_DEVICES=3 python evaluation_scripts/test_12scenes.py --stride=1 --modality=p-rgbd --scaled_prgbd --dataset_name=12scenes --datapath=$ICL_PATH/$seq --weights=droid.pth --disable_vis $@
done
