...
for seq in ${evalset[@]}; do
    python evaluation_scripts/test_eth3d_mono.py --csv_suffix=reproduce --datapath=$ETH_PATH/$seq --weights=../../DROID-SLAM/checkpoints/reproduce_250000.pth --disable_vis --mono $@
done
