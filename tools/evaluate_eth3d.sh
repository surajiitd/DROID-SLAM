...
weights_path=checkpoints/reproduce_230000.pth

for seq in ${evalset[@]}; do    
    cmd="CUDA_VISIBLE_DEVICES=2 python evaluation_scripts/test_eth3d.py --datapath=$ETH_PATH/$seq --weights=$weights_path --disable_vis $@"
    echo cmd is: $cmd
    eval $cmd
done
