...
for seq in ${evalset[@]}; do
    CUDA_VISIBLE_DEVICES=7 python evaluation_scripts/test_12scenes.py --stride=1 --modality=rgbd --dataset_name=12scenes --datapath=$ICL_PATH/$seq --weights=droid.pth --disable_vis $@
done
