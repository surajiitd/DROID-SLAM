...
for seq in ${evalset[@]}; do
    python evaluation_scripts/test_eth3d_allinone.py --csv_suffix=weight_one2 --datapath=$ETH_PATH/$seq --weights=droid.pth --disable_vis $@
done
...
# allinone2 is just to run for diff. datasets parallely.